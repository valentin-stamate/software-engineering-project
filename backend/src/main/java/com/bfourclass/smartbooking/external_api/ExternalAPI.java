...
import com.bfourclass.smartbooking.external_api.covid.*;
import com.bfourclass.smartbooking.external_api.food.CityPricesResponse;
...
import com.bfourclass.smartbooking.external_api.instance.weather.statistical_weather.StatisticalWeather;
...
public abstract class ExternalAPI {
    ...
    public static List<FoodPrice> getFoodPrice(String location) {
        ...
        final String query = "https://www.numbeo.com/api/city_prices?api_key=%s&query=%s";
        final String requestUrl = String.format(query, Secrets.API_KEY_NUMBEO, escaped);
