...
public class LocationStatisticsJSON {
    ...
    public CovidNewsJSON covidNews;
    public AirPollution airPollution;
    public CriminalityStatistics criminalityStatistics;

    public LocationStatisticsJSON(List<HotelJSON> hotels, Weather weather, CovidStatistics covidStatistics, CovidNewsJSON covidNews, AirPollution airPollution, CriminalityStatistics criminalityStatistics) {
        this.hotels = hotels;
